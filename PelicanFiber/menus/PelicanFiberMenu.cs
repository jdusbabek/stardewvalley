            ...
            foreach (ClickableTextureComponent textureComponent in this.LinksToVisit)
            {
                if (textureComponent.containsPoint(x, y))
                {
                    switch (textureComponent.name)
                    {
                        case "blacksmith":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetBlacksmithStock(this.Unfiltered), 0, null, "Blacksmith");
                            break;
                        ...
                        case "produce":
                            ...
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetShopStock(true, this.Unfiltered), 0, null, "SeedShop");
                            break;
                        case "carpentry":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetCarpenterStock(this.Unfiltered), 0, null, "ScienceHouse");
                            break;
                        ...
                        case "fish":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetFishShopStock(Game1.player, this.Unfiltered), 0, null, "FishShop");
                            break;
                        case "dining":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetSaloonStock(this.Unfiltered));
                            break;
                        case "imports":
                            this.exitThisMenu();
                        ...
                        case "sandy":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetShopStock(false, this.Unfiltered));
                            break;
                        case "sauce":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetRecipesStock(this.Unfiltered), 0, null, "Recipe");
                            break;
                        case "bundle":
                            this.exitThisMenu();
                        ...
                        case "artifact":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetMineralsAndArtifactsStock(this.Unfiltered), 0, null, "Artifact");
                            break;
                        case "leah":
                            this.exitThisMenu();
                            Game1.activeClickableMenu = new ShopMenu2(this.ReopenMainMenu, this.ItemUtils, this.GiveAchievements, ItemUtils.GetLeahShopStock(this.Unfiltered), 0, "Leah", "LeahCottage");
                            break;
                    }
                }
            }
